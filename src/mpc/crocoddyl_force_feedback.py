...
class ForceFeedbackCrocoddylMPC:
    ...
    def __init__(
        ...
        config: ForceFeedbackMPCConfig = ForceFeedbackMPCConfig(),
    ...
    def compute_control(self, obs, t: float) -> np.ndarray:
        ...
        self.last_info = {
            ...
            "cost": float(cost),
            "iters": iters,
            "tau_des_inf": tau_des_inf,
            "tau_meas_state_inf": tau_meas_state_inf,
